...
class guru extends CI_Controller{
    ...
    function index()
    {
        ...
        $sql    =   "SELECT ad.hp,ad.email,ad.dosen_id,ad.nama_lengkap,ad.nip
                    FROM app_dosen as ad
                    WHERE dosen_id not in('0') $param";
    ...
    function post()
    {
        if(isset($_POST['submit']))
        {
            ...
            $account        = array('username'=>$username,'password'=>  md5($password),'keterangan'=>$id,'level'=>4);
