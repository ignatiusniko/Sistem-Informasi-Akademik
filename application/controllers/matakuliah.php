...
class matakuliah extends CI_Controller{
    ...
    var $pk     =   "makul_id";
    var $title  =   "Kelola Mata Pelajaran";
    ...
    function tampilmakul()
    {
        ...
        $makul          =   $this->db->query($query)->result();
            echo"<table class='table table-bordered'>
            <tr><th width=10>No</th><th width=20>Kode</th><th width=40>Tipe Belajar</th>
            <th>Nama Matakuliah</th><th width=60>JAM</th><th colspan=3>Operasi</th></tr>";
            $no=1;
            foreach ($makul as $m)
            {
                echo "<tr id='hide$m->makul_id'><td>$no</td>
                                        ...
                                        <td>".  strtoupper($m->kode_kelompok)."</td>
                                            ...
                                            if($m->aktif=='y')
                                                            {
                                                                echo"<td width=10>Aktif</td>";
                                                            }
                                                            else
                                                            {
                                                                echo"<td width='10'>Mati</td>";
                                                            }
                                                             echo"<td width='10'>".anchor("matakuliah/edit/".$m->makul_id,"Edit",array('title'=>'Edit'))."</td>
