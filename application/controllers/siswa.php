...
class siswa extends CI_Controller{
    ...
    function tampilkansiswa()
    {
        ...
        echo "<tr><th width='5'>No</th><th width='70'>No Induk</th><th>NAMA</th>
            <th width=120>Jenis Kelamin</th><th>Alamat</th>
        ...
        foreach ($data as $r)
        {
            ...
            echo "<tr id='hide$r->siswa_id'>
                ...
                <td width=5>".anchor('siswa/edit/'.$r->siswa_id,'Edit',array('title'=>'edit data'))."</td>
                <td width=5 onclick='hapus($r->siswa_id) '>Hapus</i></td>";
