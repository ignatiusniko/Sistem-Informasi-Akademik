...
<body>
  ...
  <nav class="navbar navbar-white navbar-fixed-top">
        ...
        <ul class="nav navbar-nav">
         ...
         foreach ($mainmenu as $m)
         {
            ...
            if($submenu->num_rows()>0)
            {
                ...
                <a href='javascript:void(0)' class='dropdown-toggle' data-toggle='dropdown'> ".  strtoupper($m->nama_mainmenu)." <b class='caret'></b></a>
                <ul class='dropdown-menu'>";
                    foreach ($submenu->result() as $s)
                    {
                        echo "<li>".  anchor($s->link,  ''.strtoupper($s->nama_submenu))."</li>";
                    }
                    echo"</ul>
                </li>";
                                        // end looping
            ...
            {
                echo "<li>".  anchor($m->link,  ''.strtoupper($m->nama_mainmenu))."</li>";
            }
        }
        ?>
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"> <?php echo strtoupper($this->session->userdata('username'));?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><?php echo anchor('users/profile'," Account");?></li>
...
<hr>
<p align='center' style="font-weight: bold;" >Sistem Informasi Sekolah</p>
      <!--
