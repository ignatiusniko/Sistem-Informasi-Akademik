...
<div class="push">
    <ol class="breadcrumb">
        <li></i> <a href="javascript:void(0)">Home</a></li>
...
<div class="col-sm-9">
    ...
    <table class="table table-bordered" id="makul">
        <tr><th width="5">No</th><th width="100">Kode</th><th width="50">Tipe Belajar</th><th>Matakuliah</th><th width="40">SKS</th><th colspan="3">Operasi</th></tr>
    </table>
</div>
